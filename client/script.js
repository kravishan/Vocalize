...
async function transcribeAudio(audioBlob) {
  ...
  xhr.open('POST', 'http://34.30.26.167:8080/transcribe-audio', true);
...
async function generateImprovedReviewWithoutStars(whisperText) {
    try {
        ...
        const response = await fetch('http://34.30.26.167:8080/generate-improved-review', {
            method: 'POST',
            headers: {
...
async function generateImprovedReviewWithStars(globalWhisperText, selectedOverallStarCount, foodRating, serviceRating, atmosphereRating) {
    try {
        ...
        const response = await fetch('http://34.30.26.167:8080/generate-improved-review-with-stars', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
