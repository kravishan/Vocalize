...
async function transcribeAudio(audioBlob) {
  ...
  xhr.open('POST', 'https://coral-app-mbl5v.ondigitalocean.app/server/transcribe-audio', true);
...
async function generateImprovedReviewWithoutStars(whisperText) {
    try {
        ...
        const response = await fetch('https://coral-app-mbl5v.ondigitalocean.app/server/generate-improved-review', {
            method: 'POST',
            headers: {
...
async function generateImprovedReviewWithStars(globalWhisperText, selectedOverallStarCount, foodRating, serviceRating, atmosphereRating) {
    try {
        ...
        const response = await fetch('https://coral-app-mbl5v.ondigitalocean.app/server/generate-improved-review-with-stars', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
