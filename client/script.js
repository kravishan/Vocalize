...
async function transcribeAudio(audioBlob) {
  ...
  xhr.open('POST', 'https://walrus-app-poxwt.ondigitalocean.app/vocalizer-server/transcribe-audio', true);
...
async function generateImprovedReviewWithoutStars(whisperText) {
    try {
        ...
        const response = await fetch('https://walrus-app-poxwt.ondigitalocean.app/vocalizer-server/generate-improved-review', {
            method: 'POST',
            headers: {
...
async function generateImprovedReviewWithStars(globalWhisperText, selectedOverallStarCount, foodRating, serviceRating, atmosphereRating) {
    try {
        ...
        const response = await fetch('https://walrus-app-poxwt.ondigitalocean.app/vocalizer-server/generate-improved-review-with-stars', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
