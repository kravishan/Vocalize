...
app.post('/refine-review', async (req, res) => {
  try {
    ...
    const prompts = [
      ...
      "If the user requests additional information, the temperature should be set to 0.1 max it can be goes upto 0.2. If the user requests to make the review more creative, the temperature should be set to 0.5 max it can be goes upto 0.7",
    ];
